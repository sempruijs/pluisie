...
<div class="flex-1 bg-gradient-plant pt-16">
  ...
  <div class="max-w-8/10 mx-auto">
    <div
      class="h-auto bg-color-register mx-auto m-10 p-8 rounded-xl shadow-2xl shadow-black"
    >
      <p>Bedankt voor je interesse!</p>
      <p class="py-3">
        Wat leuk dat je vrijwilliger wilt worden bij Science Café Hideout!
        Dankzij enthousiaste studenten zoals jij kunnen we elke dag een
        gezellige plek maken voor studenten en docenten op de uithof.
      </p>
      <p class="py-3 font-semibold">Belangrijk: IVA-certificaat</p>
      <p>
        Voordat je achter de bar mag staan, moet je het IVA-certificaat
        (Instructie Verantwoord Alcohol schenken) halen. Deze gratis e-learning
        duurt ongeveer 15 minuten en kan je doen via de website van NOC*NSE.
      </p>
      <p class="py-3">
        Hier leer je hoe je veilig en verantwoord alcohol schenkt. Zodra je de
        e-learning correct afrond, heb je je IVA!
      </p>
    </div>
    <div>
    ...
    <div class="py-8 sha">
      <div class="flex gap-2 w-full">
        ...
        <div class="form-control w-1/6">
          <h3 class="form-label textcontrast">Tussenvoegsel:</h3>
          <input
            type="text"
      ...
      <div class="w-full mb-3">
        <label class="block mb-1 text-black"
          ><h3 class="textcontrast">Selecteer je vereniging:</h3></label
        >
        ...
        <div class="relative">
          ...
          >
            {selected}
            <span
              class="absolute right-3 transition-transform duration-500"
          ...
          <div bind:this={dropdownContainer}>
            {#if open}
              <ul
                class="w-full mt-1 bg-white border border-gray-400 rounded-lg shadow max-h-40 overflow-y-auto"
                transition:slide
              >
      ...
      <div class="form-control">
        ...
        <div
          class="w-full mx-auto h-50 bg-dragfile shadow-2xl border-2 border-dashed border-gray-400 mb-3"
        >
      ...
      {#if showPopup}
        <div class="popup-container">
          <div class="popup">
            <p>
              We zullen zo spoedig mogelijk contact met je opnemen om je één
              dagje in te werken en om je te verwelkomen in onze fantastische
              vrijwilligers groep.
            </p>
            <p class="mt-2">
              Nogmaals, bedankt voor je bereidheid om bij te dragen aan het
              succes van het Science Café Hideout!
            </p>
            <p class="pt-3 font-semibold">Met vriendelijke groet,</p>
            <p>Het bestuur van Science Café Hideout</p>
          </div>
        </div>
      {/if}
    </div>
