...
export declare namespace Types {
    ...
    type PForNotMatch<P> = [ToSafeRefinement<P>] extends [infer X] ? X : never;
    /**
     * @since 1.0.0
     */
    ...
    type ResolvePred<A> = A extends never ? never : A extends SafeRefinement<infer _A, infer _R> ? _R : A extends Predicate.Refinement<any, infer P> ? P : A extends Predicate.Predicate<infer P> ? P : A extends Record<string, any> ? {
    ...
    type ExtractAndNarrow<Input, P> = Input extends infer I ? P extends SafeRefinement<infer _In, infer _R> | Predicate.Refinement<infer _In, infer _R> ? P extends SafeRefinement<I & {}, infer _R> | Predicate.Refinement<I & {}, infer _R> ? [
        0
    ] extends [1 & _R] ? I : _R : Extract<I, _R> : P extends Predicate.Predicate<infer _In> ? P extends Predicate.Predicate<I & {}> ? _In : never : Exclude<I extends ReadonlyArray<any> ? P extends ReadonlyArray<any> ? {
